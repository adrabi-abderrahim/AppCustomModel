...
import me.adrabi.appcustomtfmodel.models.DownloadingModel
import java.util.*
import kotlin.concurrent.scheduleAtFixedRate


class DownloadModelService private constructor(_context: Context) {
    ...
    companion object {
        fun build(context: Context) = DownloadModelService(context)
    }
}